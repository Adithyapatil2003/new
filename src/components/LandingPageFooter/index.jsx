...
const LandingPageFooter = (props) => {
  return (
    <footer className={`bg-red-300 ${props.className} mb-100`}>
        ...
        <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
          <div className="flex flex-col gap-[43px] items-start justify-start w-[341px] mt-[-50px]">
            <div className="flex flex-row gap-[11px] md:h-auto items-center justify-start w-[341px]">
              <Text className="text-blue-500 text-xl w-auto text-[50px] mb-40" size="txtMarkoOneRegular20">
                LLG.
              </Text>
            </div>
            <div className="flex flex-col gap-7 h-[194px] md:h-auto items-start justify-start w-full mb-20 ">
              <Text className="leading-[160.00%] text-base text-gray-900 mb-5" size="txtManropeSemiBold16" style={{ fontSize: '25px' }}>
                <>
                  CONTACT US<br />
                  Let's get in touch
                </>
              ...
              <div className="flex items-center mb-0  gap-2">
                ...
                <Text className="leading-[160.00%] text-base text-gray-900 ml-2" size="txtManropeSemiBold16">
                  Bengaluru, India
                </Text>
              </div>
              <div className="flex items-center mb-0 gap-2">
                <img width="30" height="30" src="https://img.icons8.com/fluency/48/phone.png" alt="phone" />
                <Text className="text-base text-gray-900 ml-2" size="txtManropeSemiBold16">
                  Phone: +91 9845904748
                </Text>
              </div>
              <div className="flex items-center mb-0 gap-2">
