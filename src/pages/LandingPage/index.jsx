...
const LandingPagePage = () => {
  ...
  return (
    ...
    <div className="Landing">
     <div className="bg-deep_orange-50 text-white-A700 text-center py-11 fixed w-full z-100 absolute"></div>
    <div style={{ position: 'absolute', bottom: '80.8%', right: '180%',left:'2%', transform: 'translate(-50%, -50%)', color: 'black', fontSize: '60px', fontFamily: 'Impact, Haettenschweiler, "Arial Narrow Bold", sans-serif', fontWeight: 'bold' }}>LLG.</div>
